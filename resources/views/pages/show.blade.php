                ...
                <div class="col-md-8">
                    ...
                    <div class="bottom-comment"><!--bottom comment-->
                        <div class="comment-img">
                            <img class="img-circle" src="{{ $comment->user->getAvatar() }}" alt="" width="50" height="50">
                        </div>
                    ...
                    <div class="leave-comment"><!--leave comment-->
                        ...
                        <form class="form-horizontal contact-form" role="form" method="post" action="/comment">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
										<textarea class="form-control" rows="6" name="message" placeholder="Write comment..."></textarea>
                                </div>
                            </div>
