...
// Подключаем стили для админки и склеиваем в один
mix.styles([
...
// Подключаем скрипты для админки и склеиваем в один
mix.scripts([
    ...
    'resources/assets/admin/dist/js/scripts.js', // самописный js объеденен в один скрипт
], 'public/js/admin.js');
...
mix.copy('resources/assets/admin/plugins/ckeditor', 'public/plugins/ckeditor');
mix.copy('resources/assets/admin/plugins/ckfinder', 'public/plugins/ckfinder');